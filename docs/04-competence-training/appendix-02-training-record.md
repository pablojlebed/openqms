...
title: "04.2 Appendix 2 – Training Record and Performance Monitoring"
description: Individual training history and competence monitoring record for each employee.
---
...
A separate Training Record is maintained for each employee. The **Quality Manager** coordinates record-keeping; the **Technical Manager** and **Supervisors** provide competence assessments and observations. Records are retained according to [Procedure 00 — Document and Record Control](../document-record-control/).
