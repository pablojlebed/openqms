---
title: "04 – Competence, Training and Awareness"
description: Procedure for ensuring all laboratory personnel are competent and receive appropriate training per ISO/IEC 17025 clause 6.2.
---
...
1. **Technical Manager** reviews résumé and qualifications against the competence requirements.
2. Interviews assess relevant knowledge and experience.
3. References are checked to verify previous relevant experience.
4. If qualifications are incomplete, **Technical Manager** identifies required training before the person can work independently.
...
Results are documented in the **Training Program** ([Appendix 04-App-01](./appendix-01-training-program)).
...
1. **Supervisor** documents the specific concerns and discusses with the person
2. **Technical Manager** assesses whether refresher training or evaluation is needed
3. If significant concerns exist, the person's authorization may be suspended pending retraining and re-evaluation
4. **Quality Manager** documents the concern and outcome in **Appendix 04-App-02**

## 11. Related documents

| Document | Reference |
|---|---|
| Appendix 1 — Training Program | [04-App-01](./appendix-01-training-program) |
| Appendix 2 — Training Record and Performance Monitoring | [04-App-02](./appendix-02-training-record) |
| Appendix 3 — Record of Attendance | [04-App-03](./appendix-03-record-of-attendance) |
| Appendix 4 — Competence Approval and Authorization Record | [04-App-04](./appendix-04-competence-approval) |
| Procedure 00 — Document and Record Control | [Procedure 00](../document-record-control/) |
| Procedure 02 — Quality Policy | [Procedure 02](../quality-policy/) |
| Procedure 18 — Internal Audit | [Procedure 18](../internal-audit/) |
