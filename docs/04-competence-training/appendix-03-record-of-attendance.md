...
title: "04.3 Appendix 3 – Record of Attendance"
description: Sign-in sheet documenting attendance at induction, training sessions, and awareness meetings.
---
...
The **Quality Manager** (or session facilitator) completes an attendance record for each training event. Records are retained for the duration specified in [Procedure 00 — Document and Record Control](../document-record-control/).
