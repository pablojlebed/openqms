...
title: "02.1 Appendix 1 – Quality Objectives"
description: Register for documenting, tracking, and reviewing the laboratory's quality objectives.
---
...
1. The **Quality Manager** establishes quality objectives in consultation with the **Technical Manager** and **Laboratory Director**, as described in [Procedure 02, section 6.5](./#65-quality-objectives).
2. Each objective should be specific, measurable, achievable, relevant, and time-bound.
3. Update the "Current value / status" column periodically (e.g., quarterly) to track progress.
...
**Objectives established by:** *[Name, role]*
**Date:** *[Date]*
