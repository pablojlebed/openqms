...
title: "06.1 Appendix 1 – Supplier Evaluation and Approval Record"
description: Template for evaluating and approving external suppliers of products and services.
---
...
1. The **Quality Manager** initiates a new record when a supplier is first considered or when a re-evaluation is due.
2. The **Technical Manager** provides input on technical capability and past performance.
3. The completed record is signed by the **Quality Manager** and approved by the **Laboratory Director** (for subcontracting) or **Technical Manager** (for products).
4. The outcome is reflected in the Approved Supplier List ([06-App-02](./appendix-02-approved-supplier-list)).
