...
description: Laboratory project plan for implementing the ISO/IEC 17025 quality management system, from gap analysis through accreditation and ongoing maintenance.
---
...
4. The completed gap analysis is documented using the **Gap Analysis Checklist** ([Appendix 1](./appendix-01-gap-analysis)).
5. The **Quality Manager** presents the gap analysis findings to the **Laboratory Director** for review.

### 6.3 Planning

1. Based on the gap analysis results, the **Quality Manager** develops a detailed **implementation timeline** ([Appendix 2](./appendix-02-implementation-timeline)) that includes:
...
2. Each document is created, reviewed, and approved following [Procedure 00 — Document and Record Control](../00-document-record-control/index.md).
...
1. As procedures and work instructions are approved, the **Quality Manager** coordinates their deployment:
   - Documents are distributed to personnel at their points of use (per [Procedure 00](../00-document-record-control/index.md)).
   - Personnel are trained on new or revised procedures relevant to their roles.
2. Training is planned and recorded in accordance with [Procedure 04 — Competence and Training](../04-competence-training/index.md). At a minimum, training shall cover:
...
1. The **Quality Manager** plans and conducts at least one full **internal audit** of the QMS in accordance with [Procedure 18 — Internal Audit](../18-internal-audit/index.md).
...
3. The **Laboratory Director** conducts a **management review** in accordance with [Procedure 19 — Management Review](../19-management-review/index.md), covering at a minimum:
...
1. The **Quality Manager** ensures that all nonconformities identified during the internal audit and management review are addressed through corrective actions in accordance with [Procedure 14 — Complaints and Nonconformity](../14-complaints-nonconformity/index.md).
...
1. After initial accreditation, the laboratory maintains the QMS through:
   ...
   - **Internal audits:** Conducted at planned intervals (at least annually) per [Procedure 18](../18-internal-audit/index.md).
   - **Management reviews:** Conducted at planned intervals (at least annually) per [Procedure 19](../19-management-review/index.md).
   - **Continual improvement:** Opportunities for improvement are identified through audits, reviews, customer feedback, and day-to-day operations, and acted upon in accordance with [Procedure 21 — Continuous Improvement](../21-continuous-improvement/index.md).
...
| Document | Reference |
|---|---|
| Appendix 1 — Gap Analysis Checklist | [01-App-01](./appendix-01-gap-analysis) |
| Appendix 2 — Implementation Timeline | [01-App-02](./appendix-02-implementation-timeline) |
| 00 — Document and Record Control | [Procedure 00](../00-document-record-control/index.md) |
| 02 — Quality Policy | [Procedure 02](../02-quality-policy/index.md) |
| 03 — Quality Manual | [Procedure 03](../03-quality-manual/index.md) |
| 04 — Competence and Training | [Procedure 04](../04-competence-training/index.md) |
| 14 — Complaints and Nonconformity | [Procedure 14](../14-complaints-nonconformity/index.md) |
| 18 — Internal Audit | [Procedure 18](../18-internal-audit/index.md) |
| 19 — Management Review | [Procedure 19](../19-management-review/index.md) |
| 21 — Continuous Improvement | [Procedure 21](../21-continuous-improvement/index.md) |
