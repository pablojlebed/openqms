...
title: "01.2 Appendix 2 – Implementation Timeline"
description: Template timeline for planning the QMS implementation phases, milestones, and responsibilities.
---
...
1. The **Quality Manager** completes this timeline based on the gap analysis findings ([Appendix 1](./appendix-01-gap-analysis)) and the resources allocated by the **Laboratory Director**.
...
**Timeline prepared by:** *[Name, role]*
**Date:** *[Date]*
